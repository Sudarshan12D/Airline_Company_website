    ...
    public static void main(String[] args) {
        ...
        viewFlightsButton.addActionListener(e -> {
            ...
            topPanel.setBorder(BorderFactory.createCompoundBorder(
             ...
             //...................................REGISTER FOR MEMBERSHIP Listener........................................
            // Register for Membership Button
            JButton registerButton = new JButton("Register for Membership");
            registerButton.addActionListener(ev -> {
                // Create a new frame for membership registration
                JFrame registerFrame = new JFrame("Membership Registration");
                ...
                // Credit Card field
                registrationPanel.add(new JLabel("Credit Card Info:"), gbc);
                gbc.gridx++;
                JTextField creditCardField = new JTextField(20);
                registrationPanel.add(creditCardField, gbc);
                ...
                submitButton.addActionListener(submitEvent -> {
                    // Validation logic here (simplified for example)
                    if (emailField.getText().trim().isEmpty() || creditCardField.getText().trim().isEmpty()) {
                        JOptionPane.showMessageDialog(registerFrame, "Email or Credit Card info cannot be empty.", "Error", JOptionPane.ERROR_MESSAGE);
                    } else {
                ...
                registerFrame.add(registrationPanel, BorderLayout.CENTER);
            ...
            // Add the Register button to the panel (Assuming 'authButtonsPanel' is the panel where you want to add this button)
            authButtonsPanel.add(registerButton);
